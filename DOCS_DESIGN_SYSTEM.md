...
53: 
54: ### 5. Enlaces (Links)
55: - **Color**: Azul (`#4a86e8`) para mantener la semántica web.
56: - **Grosor**: Forzado a **no negrita** (`font-weight: 400`) para una lectura más ligera.
57: - **Interacción**: Cambio suave a color primario en `hover`.
